...
export default class Kontakt extends Component{
    render(){
        return(
            ...
            <Row className="mx-5 m-4" style={{position: 'relative'}}> 
                        <Col md="4" className="mx-5">
                                    <Card className="page-title m-4" border="light">
                ...
                <Form className="mb-5" style={{position: 'absolute', right:'5px', bottom:'-100px', width:'50%'}}>
